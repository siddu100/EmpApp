...
public class EmployeeDbDeclaration implements EmployeeDeclaration{
    
    List<Employee> eList = null;
	private final Connection conn = DBConnectionOracleDB.getInstance().getConnection();
    ...
    public boolean add(Employee employee){
		/*String insertTableSQL = "INSERT INTO EMPLOYEE "
				+ "(FIRSTNAME, LASTNAME, EMAIL, PHONE, BIRTHDATE, TITLE, DEPARTMENT) "
				+ "VALUES(?,?,?,?,?,?,?)";*/
		String insertTableSQL = "INSERT INTO EMPLOYEE "
